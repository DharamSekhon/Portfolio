...
const Header = () => {
  ...
  return (
    <header className="fixed shadow-xl px-5 py-3 flex flex-col md:flex-row justify-between items-center top-0 left-0 ml-[2.5rem] md:ml-[9rem] w-50% md:w-[80%] mt-5 rounded-3xl backdrop-blur-2xl backdrop-filter z-10 text-white">
